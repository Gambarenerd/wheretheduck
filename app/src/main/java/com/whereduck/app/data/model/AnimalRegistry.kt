...
object AnimalRegistry {
    ...
    private val allAnimals: Map<String, AnimalInfo> = mapOf(
        ...
        "robot" to AnimalInfo("robot", "\uD83E\uDD16", "Robot", R.raw.robot, drawableRes = R.drawable.roboto, topPadding = 35.dp),
        "duck" to AnimalInfo("duck", "\uD83E\uDD86", "Anatra", R.raw.magiaz_duck_405695, drawableRes = R.drawable.duck_icon, cardRes = R.drawable.card_duck),
